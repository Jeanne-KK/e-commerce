        ...
        <div className="flex flex-col min-h-screen font-roboto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 md:pt-10 gap-y-5 text-lg xl:text-xl pl-5 pr-5">
                ...
                <div className="space-y-5 xl:space-y-10 md:pl-5 md:pr-5">
                    ...
                    <div className="ml-10 flex gap-x-10">
                        {product.map((rows) => (
                            <input value="red" name="choice"
                                className={`size-8 bg-${rows.v_color} border-1 appearance-none rounded-full forced-color-adjust-none checked:outline-2 checked:outline-offset-2 focus-visible:outline-3 focus-visible:outline-offset-3`}
                    ...
                    <button onClick={handle} className="bg-indigo-600 text-white w-full md:max-w-75 p-3 rounded-md cursor-pointer">Add to cart</button>
                </div>
